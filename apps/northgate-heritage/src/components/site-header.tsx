      ...
      <div className="bg-foreground text-background-card">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-1.5 sm:py-2 text-[6px] sm:text-[8px] font-medium tracking-[0.16em] uppercase">
          ...
          <span className="hidden sm:inline opacity-65">
            Licensed agents · No obligation
          </span>
        </div>
      </div>

      <header className="sticky top-0 z-30 h-16 sm:h-20 bg-background/95 backdrop-blur-sm shadow-[0_1px_3px_rgba(20,37,58,0.06)]">
        ...
        <a
          ...
          className="sm:hidden text-[13px] font-medium tracking-[-0.005em] text-accent-terracotta"
        >
          (800) 555-0147
        </a>
      </div>
