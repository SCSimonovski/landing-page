    ...
    <footer className="bg-background-deep text-background-card px-6 py-14 sm:py-20">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-7 sm:flex-row sm:items-start sm:justify-between border-b border-background-card/12 pb-7">
          <div>
            ...
            <p className="text-[13px] leading-[1.65] mt-4 opacity-70 max-w-[420px]">
              A small service that connects families with licensed insurance agents.
            </p>
          </div>
          <nav
            aria-label="Footer"
          ...
          >
            ...
            <a
              href="mailto:hello@northgateheritage.com"
              className="opacity-85 hover:opacity-100 min-h-11 inline-flex items-center"
            >
              Contact
            </a>
        ...
        <div className="mt-6 space-y-1.5 text-xs leading-[1.7] opacity-55 max-w-[640px]">
          <p>Northgate Heritage is operated by Northgate Lead Services LLC.</p>
          <p>
