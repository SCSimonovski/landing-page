  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 sm:py-20">
        <div
          role="alert"
          className="mb-10 rounded-2xl border border-accent-coral/30 bg-background-card p-5 text-sm text-foreground-soft"
        >
          <strong className="text-accent-coral">DRAFT — pending TCPA-experienced attorney review.</strong>{" "}
        ...
        <div className="mt-10 space-y-9 text-foreground">
          ...
          <section>
            ...
            <p className="mt-3 text-[15.5px] leading-[1.65] text-muted">
              ...
              licensed insurance agent who is authorized to contact you.{" "}
